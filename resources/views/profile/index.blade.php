            ...
            <div class="">
                ...
                <div class="home-container">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div>
                                <a href="{{ route('message.create', [$user->id]) }}" class="btn btn-secondary rounded-0">Send this user a message</a>
                            </div>
                        </div>
                                        ...
                                        <li class="list-group-item">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a href="{{ route( 'follow', [ $friend->id ] ) }}" class="btn btn-link btn-sm p-0 m-0">Follow</a>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
